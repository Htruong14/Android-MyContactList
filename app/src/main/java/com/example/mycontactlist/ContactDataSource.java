...
public class ContactDataSource {
    ...
    public boolean insertContact(Contact c) {
        ...
        try {
            ...
            if (c.getPicture() != null) {
                ...
                ByteArrayOutputStream baos = new ByteArrayOutputStream(); //must be converted to byte array to be store in database
    ...
    public boolean updateContact(Contact c) {
        ...
        try {
            ...
            updateValues.put("bff", c.isBFF());

            didSucceed = database.update("contact", updateValues, "_id="
                    + rowId, null) > 0;
        }
        catch (Exception e) {
            //Do nothing - will return false if there is an exception
    ...
    public Contact getSpecificContact(int contactId) {
        ...
        if (cursor.moveToFirst()) {
            ...
            if (photo != null) {
                ...
                contact.setPicture(thePicture); //getting pic from database
            }
